...
{{--<!-- <form action="{{ url('admin/createTask') }}" method="post">--}}
    {{--{{ csrf_field() }}--}}
    {{--任务名字：<input type="text" name="name" />--}}
    {{--开始时间：<input type="date" name="start_time" />--}}
    {{--工时：<input type="number" name="work_hours">--}}
    {{--需要人数：<input type="number" name="need_num">--}}
    {{--<input type="submit">--}}
{{--</form> -->--}}
...
<form class="form" action="{{ url('admin/createTask') }}" style="padding: 20px;" method="post">
  {{ csrf_field() }}
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="hidden" name="Publisher" value="{{session ('adminName')}}" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
