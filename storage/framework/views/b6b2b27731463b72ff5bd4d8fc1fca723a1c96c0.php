...
<html class="ui-page-login">
	...
	<head>
		...
		<title></title>
		<link href="<?php echo e(asset('css/mui.min.css')); ?>" rel="stylesheet" />
		<link href="<?php echo e(asset('css/style.css')); ?>" rel="stylesheet" />
		
		<link href="<?php echo e(asset('css/mui.picker.css')); ?>" rel="stylesheet" />
		<link href="<?php echo e(asset('css/mui.poppicker.css')); ?>" rel="stylesheet" />
		<script src="<?php echo e(asset('js/mui.min.js')); ?>"></script>
		<script src="<?php echo e(asset('js/mui.picker.js')); ?>"></script>
		<script src="<?php echo e(asset('js/mui.poppicker.js')); ?>"></script>
	...
	<body>
		...
		<div class="mui-content">
			...
			<form action="<?php echo e(url('addUser')); ?>" method="post" id='login-form' class="mui-input-group">
					<?php echo e(csrf_field()); ?>

					<input type="hidden" name="openid" value="<?php echo e($user['openid']); ?>">
					<input type="hidden" name="nickname" value="<?php echo e($user['nickname']); ?>">
					<input type="hidden" name="sex" value="<?php echo e($user['sex']); ?>">
					<input type="hidden" name="headimgurl" value="<?php echo e($user['headimgurl']); ?>">
				
				<div class="mui-input-row">
						<label>学号</label>
						<input type="text" name="student_id" id='account' placeholder="请输入学号" value="<?php echo e(old('student_id')); ?>" class="mui-input-clear mui-input">
				</div>
				<?php if($errors->has('student_id')): ?>
				<div  style="color:red;text-align:center;margin-top:3px;margin-bottom:5px;"><span><?php echo e($errors->first('student_id')); ?></span></div>
				<?php endif; ?>
				
				<div class="mui-input-row">
						<label>姓名</label>
						<input type="text" name="name" id="" placeholder="请输入姓名"  value="<?php echo e(old('name')); ?>"  class="mui-input-clear mui-input">
				</div>
				<?php if($errors->has('name')): ?>
				<div  style="color:red;text-align:center;margin-top:3px;margin-bottom:5px;"><span><?php echo e($errors->first('name')); ?></span></div>
				<?php endif; ?>
				
				<div class="mui-input-row">
						<label>手机</label>
						<input type="number" name="phone" id="" placeholder="请输入手机号码"  value="<?php echo e(old('phone')); ?>"  class="mui-input-clear mui-input">
				</div>
				<?php if($errors->has('phone')): ?>
				<div  style="color:red;text-align:center;margin-top:3px;margin-bottom:5px;"><span><?php echo e($errors->first('phone')); ?></span></div>
				<?php endif; ?>
