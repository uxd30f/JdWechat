...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('themes/desktop/style/desktop.css?t')); ?>">
...
<!--桌面app配置参数-->
<script type="text/javascript" src="<?php echo e(asset('themes/desktop/js/desktop.data.js')); ?>"></script>
<!--主桌面-->
    ...
    <div id="opening-menu" class="opening-menu">
        ...
        <div class="opening-menu-user">
            ...
            <div class="opening-menu-user-list">
                ...
                <a title="注销登录" data-type="loginout" class="dock_tool_loginout small-click" href="<?php echo e(url('exit')); ?>">注销登录</a>
            </div>
        </div>
    </div>
    <!--开始菜单-->
...
<div class="desktop-menu">
    <ul>
        ...
        <hr/>
        <li><a href="<?php echo e(url('exit')); ?>" class="small-click" data-type="loginout">注销</a></li>
    </ul>
</div>
</body>
<script src="<?php echo e(asset('themes/layui/lay/dest/layui.all.js')); ?>"></script>
<script src="<?php echo e(asset('themes/desktop/js/swiper.js')); ?>"></script>
<script src="<?php echo e(asset('themes/desktop/js/desktop.js')); ?>"></script>
<script>
    var _hmt = _hmt || [];
    (function () {
